...
const PROJECTS = [
  ...
  },
  {
    ...
    title: "블록체인 유언장",
    period: "학부",
    oneLiner: "스마트 컨트랙트로 위·변조 없이 유언을 보관하고, 조건에 따라 안전하게 공개·실행하는 서비스. (상세 내용은 추후 보완)",
    stack: ["Solidity", "Ethereum", "Web3.js", "React"],
    problem: [
      "유언장은 위·변조와 분실 위험이 크고, 공개 시점과 신원 확인을 신뢰할 수 있는 방식으로 보장하기 어렵습니다.",
      "(여기에 직접 정의한 문제 상황을 채워 넣어 주세요.)",
    ],
    role: [
      "(팀에서 맡은 역할을 적어 주세요 — 예: 스마트 컨트랙트 설계 / 프론트엔드 연동)",
    ],
    solution: [
  ...
  },
  {
    ...
    title: "AI 구술 자서전",
    period: "학부",
    oneLiner: "대화형 AI가 어르신의 이야기를 인터뷰하듯 끌어내고, 구술을 자서전 텍스트로 엮어 주는 서비스. (상세 내용은 추후 보완)",
    ...
    role: [
      "(팀에서 맡은 역할을 적어 주세요 — 예: 인터뷰 프롬프트 설계 / 음성 파이프라인)",
    ],
    solution: [
